      ...
      >
        ...
        >
          ...
          <el-input v-model="register.email">
            <el-button slot="append" type="primary" @click="sendCode()"
              >確認コードを送信</el-button
            >
          </el-input>
          <!-- <el-alert
   ...
   data() {
    ...
    rules: {
      ...
      password: [
        ...
        { min: 6, max: 30,message: 'パスワードは6~30文字にしてください', trigger: 'blur' },
      ...
      email: [
        ...
        { type: 'email', message: '正しいメールアドレスの形式で入力してください．', trigger: "blur"}
      ],
      code:[
        { required: true, message: '確認コードを入力してください', trigger: 'blur'},
        { pattern: /[0-9]+/, message: '正しいコードを入力してください',trigger: 'blur'}
      ]
      }
    };
  },
  ...
  methods: {
    submitForm(formName) {
      ...
      postData(formData){
        ...
        register(formData).then(res =>{ //このregisterはimportしたAPI dataではない．
          //成功した場合，
            this.$message({
            message: '新規会員登録しました',
            type: 'success'
